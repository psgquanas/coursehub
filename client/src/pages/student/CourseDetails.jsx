...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-10 pt-12 text-left">
        <div className="absolute top-0 left-0 w-full section-height z-[1] bg-gradient-to-b from-cyan-100/70"></div>
        {/** left column */}
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="course-details-heading-small font-semibold text-gray-800">
          ...
          <p className="text-sm">
            Course by:{" "}
            <span className="text-blue-600 underline">Desmond Selorm</span>
          </p>
